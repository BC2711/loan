                    ...
                    <table class="table fs--1 mb-0 border-top border-200">
                        <thead id="leave">
                            <tr>   
                                ...
                                <th class="sort" scope="col" data-sort="Status">Amount</th>
                                <th class="sort" scope="col" data-sort="Role"> Status</th>
                                <th class="sort" scope="col" data-sort="Username">Stage</th>
                                <th class="sort" scope="col" data-sort="Status">Age</th>
