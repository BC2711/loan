...
@section('content')
    <nav class="mb-2" aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active">Merchant Emploees</li>
        </ol>
    </nav>
    ...
    <div class="col-sm-6 col-md-9 col-lg-12 m-4">
        <div class="card text-white success" id="card">
            <div class="card-body">
                <h4 class="card-title text-dark">Merchant Employees </h4>
            </div>
        </div>
    </div>
                            ...
                            <div class="row g-2 gy-3">
                                ...
                                <div class="col-auto">
                                    <a class="btn btn-sm btn-phoenix-secondary bg-white hover-bg-100 me-2"
                                        href="/createmerchantemployee">Create New Employee</a>
