...
@section('content')
    <nav class="mb-2" aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active">Merchant Outlets</li>
        </ol>
    </nav>
    ...
    <div class="col-sm-6 col-md-9 col-lg-12 m-4">
        <div class="card text-white success" id="card">
            <div class="card-body">
                <h4 class="card-title text-dark">Merchant Outlets </h4>
            </div>
        </div>
    </div>
                            ...
                            <div class="row g-2 gy-3">
                                ...
                                <div class="col-auto">
                                    <a class="btn btn-sm btn-phoenix-secondary bg-white hover-bg-100 me-2"
                                        href="/createmerchantoutlet">Create New Outlet</a>
                        ...
                        <table class="table fs--1 mb-0 border-top border-200">
                            <thead>
                                <tr>
                                    ...
                                    <th class="sort" scope="col" data-sort="Agent ">Date Created</th>
                                    <th class="sort" scope="col" data-sort="Agent ">Merchant Name</th>
                                    <th class="sort" scope="col" data-sort="Outlet">Outlet Name</th>
                                    <th class="sort" scope="col" data-sort="Code">Outlet Code</th>
                                    <th class="sort" scope="col" data-sort="Time"> Contact Name</th>
                                    <th class="sort" scope="col" data-sort="Checker ">Contact Number </th>
                                    <th class="sort" scope="col" data-sort="Status">Deposit Balance </th>
                                    <th class="sort" scope="col" data-sort="Status">District </th>        
