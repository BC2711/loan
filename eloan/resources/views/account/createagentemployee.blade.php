...
@section('content')
    <nav class="mb-2" aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active"><a href="/agentemployee">Agent Employees</a></li>
    ...
    <div class="col-sm-6 col-md-9 col-lg-12 m-4">
        <div class="card text-white success" id="card">
            <div class="card-body">
                <h4 class="card-title text-dark">Create Agent Employee </h4>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="p-4 code-to-copy">
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="floatingSelect"> Agent <span class="danger">*</span></label>
                                </div>
                                <div class="form-floating mb-3">
