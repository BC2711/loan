(function(factory) {
    ...
    const handleTooltipPosition = ([e,,t,,o])=>{
        if (window.innerWidth <= 540) {
            ...
            return r[e[0] < o.viewSize[0] / 2 ? "left" : "right"] = 5,
            r
        }
        return null
    }
    ...
    const newCustomersChartsInit = ()=>{
        const {getColor: t, getData: o, getDates: a} = window.phoenix.utils
          , e = document.querySelector(".echarts-new-customers")
          , i = t=>{
    ...
    const projectionVsActualChartInit = ()=>{
        const {getColor: t, getData: o, getPastDates: e} = window.phoenix.utils
          ...
          , a = e(10)
          , r = [44485, 20428, 47302, 45180, 31034, 46358, 26581, 36628, 38219, 43256]
            ...
            echartSetOption(i, r, (()=>({
                ...
                tooltip: {
                    ...
                    position(t, e, o, r, i) {
                        ...
                        return window.innerWidth > 540 ? t[0] <= i.viewSize[0] / 2 ? a.left = t[0] + 20 : a.left = t[0] - i.contentSize[0] - 20 : a[t[0] < i.viewSize[0] / 2 ? "left" : "right"] = 0,
                        a
                    },
    ...
    const totalSalesChartInit = ()=>{
        const {getColor: t, getData: o, getDates: a} = window.phoenix.utils
          , e = document.querySelector(".echart-total-sales-chart")
            ...
            echartSetOption(l, a, (()=>({
                ...
                xAxis: [{
                    ...
                    splitLine: {
                        ...
                        interval: 0,
                        lineStyle: {
                            color: "dark" === window.config.config.phoenixTheme ? t("gray-100") : t("gray-200")
                        }
                    },
                    boundaryGap: !1
                }, {
        ...
        if (L && e) {
            ...
            leaftletPoints.map((e=>{
                const {name: t, location: o, street: a} = e
                  ...
                  , A = `\n        <h6 class="mb-1">${t}</h6>\n        <p class="m-0 text-500">${a}, ${o}</p>\n      `
                  , s = L.popup({
                    minWidth: 180
                }).setContent(A);
                return i.bindPopup(s),
                n.addLayer(i),
                !0
            }
            )),
